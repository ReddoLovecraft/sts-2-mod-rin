...
public class TestSubjectCorpse : CorpseCardModel
{
	...
	public TestSubjectCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	...
	public override async Task TriggerWhenCombatStart()
        {
		  await PowerCmd.Apply<NemesisPower>(Owner.Creature, 1,Owner.Creature, this);
		  await PowerCmd.Apply<EnragePower>(Owner.Creature, this.DynamicVars["Power"].IntValue,Owner.Creature, this);
        }
		 ...
		 public override async Task AfterDamageReceived(PlayerChoiceContext choiceContext, Creature target, DamageResult result, ValueProp props, Creature? dealer, CardModel? cardSource)
	{
        ...
        await PowerCmd.Apply<DemisePower>(target, result.UnblockedDamage,Owner.Creature, this);
        await Task.CompletedTask;
	}
