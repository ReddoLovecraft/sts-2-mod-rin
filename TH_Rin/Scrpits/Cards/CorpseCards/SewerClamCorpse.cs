...
public class SewerClamCorpse : CorpseCardModel
{
	...
	public SewerClamCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	protected override void RefreshCorpseVars()
	{
	 ...
	 public override async Task TriggerWhenCombatStart()
        {
		  await PowerCmd.Apply<PlatingPower>(Owner.Creature, this.DynamicVars.Cards.IntValue,Owner.Creature, this);
        }
