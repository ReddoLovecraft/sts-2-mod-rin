...
public class CubexConstructCorpse : CorpseCardModel
{
	...
	public CubexConstructCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
    ...
    {
		  await PowerCmd.Apply<ArtifactPower>(Owner.Creature,this.DynamicVars.Cards.IntValue,Owner.Creature,this);
    }
