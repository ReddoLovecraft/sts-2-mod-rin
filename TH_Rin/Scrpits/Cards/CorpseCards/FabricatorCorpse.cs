...
public class FabricatorCorpse : CorpseCardModel
{
		protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[2]
        {
		  HoverTipFactory.FromPower<AutomationPower>(),
	...
	public FabricatorCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
            RefreshCorpseVars();
	}
    ...
    {
		  await PowerCmd.Apply<AutomationPower>(Owner.Creature,this.DynamicVars["Power"].IntValue,Owner.Creature,this);
    }
