...
public class InkletCorpse : CorpseCardModel
{
	...
	public InkletCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	protected override void RefreshCorpseVars()
	{
	 ...
	 public override async Task TriggerWhenCombatStart()
        {
		  await PowerCmd.Apply<SlipperyPower>(Owner.Creature, this.DynamicVars.Cards.IntValue,Owner.Creature, this);
        }
