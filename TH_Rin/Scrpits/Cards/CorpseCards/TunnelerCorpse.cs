...
public class TunnelerCorpse : CorpseCardModel
{
	...
	public TunnelerCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	protected override void RefreshCorpseVars()
	{
	 ...
	 public override async Task TriggerWhenCombatStart()
        {
             await PowerCmd.Apply<BarricadePower>(Owner.Creature, this.DynamicVars["Power"].IntValue,Owner.Creature, this);
        }
