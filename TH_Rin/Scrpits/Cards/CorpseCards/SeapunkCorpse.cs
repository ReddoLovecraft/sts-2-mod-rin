...
public class SeapunkCorpse : CorpseCardModel
{
	...
	public SeapunkCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	 ...
	 public override async Task TriggerWhenCombatStart()
        {
			...
			await CreatureCmd.GainBlock(base.Owner.Creature, base.DynamicVars.HpLoss.IntValue,ValueProp.Unpowered,null);
        }
