...
public class KinPriestCorpse : CorpseCardModel
{
	...
	public KinPriestCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	...
	public override async Task TriggerWhenCombatStart()
        {
		  await PowerCmd.Apply<RitualPower>(Owner.Creature, this.DynamicVars["Power"].IntValue,Owner.Creature, this);
        }
