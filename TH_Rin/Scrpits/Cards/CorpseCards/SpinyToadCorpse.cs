...
public class SpinyToadCorpse : CorpseCardModel
{
	...
	public SpinyToadCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	protected override void RefreshCorpseVars()
	{
	 ...
	 public override async Task TriggerWhenCombatStart()
        {
             await PowerCmd.Apply<ThornsPower>(Owner.Creature, this.DynamicVars["Power"].IntValue,Owner.Creature, this);
        }
