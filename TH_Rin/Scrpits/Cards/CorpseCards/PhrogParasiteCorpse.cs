...
public class PhrogParasiteCorpse : CorpseCardModel
{
	...
	protected override IEnumerable<DynamicVar> CanonicalVars => new List<DynamicVar> { new CardsVar(0),new EnergyVar(0)};
	public PhrogParasiteCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
