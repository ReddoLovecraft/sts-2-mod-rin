...
public class OwlMagistrateCorpse : CorpseCardModel
{
	...
	public OwlMagistrateCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
 ...
 public override async Task TriggerWhenCombatStart()
        {
           await PowerCmd.Apply<SoarPower>(Owner.Creature, this.DynamicVars["Power"].IntValue,Owner.Creature,this);
        }
