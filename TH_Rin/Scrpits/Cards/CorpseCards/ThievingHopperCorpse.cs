...
public class ThievingHopperCorpse : CorpseCardModel
{
	...
	public ThievingHopperCorpse() : base(-1, CardType.Status, CardRarity.Event, TargetType.None)
	{
		RefreshCorpseVars();
	}
	...
	{
		room.AddExtraReward(base.Owner, new CardRemovalReward(base.Owner));
