...
public abstract class RinEventModel : CustomEventModel
{
	...
	protected static bool HasAnyRin(IRunState runState)
	{
		return runState.Players.Any(p => p.Character is RinCharacter);
	}
}
