...
namespace TH_Rin.Scrpits.Powers
{
    public sealed class VigorNextTurnPower : CustomPowerModel
    {
        ...
        public override string? CustomPackedIconPath => "res://TH_Rin/ArtWorks/Powers/VNTP32.png";
        public override string? CustomBigIconPath => "res://TH_Rin/ArtWorks/Powers/VNTP64.png";
		protected override IEnumerable<DynamicVar> CanonicalVars => [new CardsVar(5)];
        public void SetCardVar(int value)
        {
        ...
        public override async Task AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
        {
			...
			Flash();
            await PowerCmd.Apply<VigorPower>(Owner,this.DynamicVars.Cards.IntValue,null,null);
