...
public class BasicBarrow : CustomRelicModel,IRightCilckable,IBarrowLike
{
	public override RelicModel? GetUpgradeReplacement()
	{
		if (!IsMutable)
		{
			return ModelDb.Relic<Barrow>();
		}

		Barrow barrow = (Barrow)ModelDb.Relic<Barrow>().ToMutable();
		barrow.SerializableCorpseCards = SerializableCorpseCards;
		try
		{
			barrow.Owner = Owner;
		}
